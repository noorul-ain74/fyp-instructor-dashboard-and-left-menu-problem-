import { BookOpen, Award, User, Calendar as CalendarIcon, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <div className="flex flex-1">
          <div className="flex-1 p-8">
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-sm">Let's learn something new today!</p>
            </div>
                ...
                {Array.from({ length: 31 }, (_, i) => i + 1).map((day) => (
                  <button
                    ...
                    className={`aspect-square flex items-center justify-center text-sm rounded-lg ${
                      day === currentDate.getDate() ? 'bg-teal-500 text-white' : 'hover:bg-gray-100'
                    }`}
                  >
                    {day}
                  </button>
